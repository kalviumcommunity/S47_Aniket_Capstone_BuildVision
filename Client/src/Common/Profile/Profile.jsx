<<<<<<< HEAD:Client/src/Common/Profile/Profile.jsx
    ...
    useEffect(() => {
        ...
        if (role === "Architect") {
            axios(`${import.meta.env.VITE_SERVER_URL}/ShowDesign/${role}/${id}`)
                .then((datas) => setdesign(datas.data))
                .catch((err) => console.log(err));
        }
    }, []);
                            ...
                            {design.map((designs) => (
                                <div className={css.designcontainer} key={designs._id}>
                                    <div className={css.designleft}>
                                        <img src={designs.ImageOfDesign[0] ? `${import.meta.env.VITE_SERVER_URL}/Upload/Design/${designs.ImageOfDesign[0].replace(/ /g, "%20")}`:""} alt="Image of Design is missing" className={css.designimage} />
                                    </div>
...
export default Profile
>>>>>>> 73f314a4a2070064dd6ac95658e5a68f16dab139:Client/src/Common/Profile.jsx
